...
public class BookingServiceImplTest {
    ...
    public void testRemoveUserFromTrainSection_Success() {
        ...
        when(ticketDetailsRepository.removeUserFromTrainSection(email, journeyDate)).thenReturn(1);
        // Executing the method under test
        String result = bookingServiceImpl.removeUserFromTrainSection(email, journeyDate);
    ...
    public void testRemoveUserFromTrainSection_Failure() {
        ...
        String email = "test@example.com";
        String journeyDate = "2024-05-16";
        when(ticketDetailsRepository.removeUserFromTrainSection(email, journeyDate)).thenReturn(0);
        // Executing the method under test
        String result = bookingServiceImpl.removeUserFromTrainSection(email, journeyDate);
        // Verifying the result
    ...
    public void testRemoveUserFromTrainSection_Exception() {
        ...
        String email = "test@example.com";
        String journeyDate = "2024-05-16";
        when(ticketDetailsRepository.removeUserFromTrainSection(email, journeyDate)).thenThrow(new RuntimeException());
        // Executing the method under test
        String result = bookingServiceImpl.removeUserFromTrainSection(email, journeyDate);
        // Verifying the result
        assertEquals("FAILURE", result);
