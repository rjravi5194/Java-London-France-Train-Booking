...
public class BookingController {
    ...
    public ResponseEntity<CustomResponse> removeUserFromTrainSection(
            @RequestParam String email, @RequestParam String journeyDate) {
        LOGGER.info(messageSource.getMessage("info.removeUserFromTrainSection.remove", null, Locale.ENGLISH));
        CustomResponse customResponse;
        try {
            String message = bookingService.removeUserFromTrainSection(email, journeyDate);
    ...
    public ResponseEntity<CustomResponse> modifyUserTicket(
            @RequestBody CustomerDetailsDao customerDetailsDao, @RequestParam String journeyDate) {
        LOGGER.info(messageSource.getMessage("info.modifyUserTicket.modify", null, Locale.ENGLISH));
        CustomResponse customResponse;
        try {
            BookingDetailsDto bookingDetailsDto = bookingService.modifyUserTicket(customerDetailsDao, journeyDate);
