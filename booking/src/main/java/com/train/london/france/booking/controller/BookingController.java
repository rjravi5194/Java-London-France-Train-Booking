...
public class BookingController {
    ...
    public ResponseEntity<CustomResponse> modifyUserTicket(
            @RequestBody CustomerDetailsDao customerDetailsDao, @RequestParam String journeyDate, @RequestParam int seatNumber) {
        LOGGER.info(messageSource.getMessage("info.modifyUserTicket.modify", null, Locale.ENGLISH));
        CustomResponse customResponse;
        try {
            BookingDetailsDto bookingDetailsDto = bookingService.modifyUserTicket(customerDetailsDao, journeyDate, seatNumber);
